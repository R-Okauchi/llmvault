...
function ConsentApp() {
  ...
  return (
    <div class="consent">
      ...
      <p class="description">
        This site wants to send requests to LLM providers using your API keys stored in LLMVault.
      ...
      <p class="warning">
        You can revoke access at any time from the LLMVault extension popup.
      </p>
    </div>
  );
}
