...
- **Capability-first SDK** — published as `keyquill@3.x` on npm. Legacy snake_case SDK clients (`@0.3.x`) continue to work against the same extension via an in-extension wire translator.
